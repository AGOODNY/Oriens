...
class OverlayTests(unittest.TestCase):
    ...
    def test_overlay_constructs_and_closes_without_network(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertTrue(window.compact_context_label.isVisible())
            ...
            self.assertIn("selection-color: #fff5db", window.styleSheet())
            ...
            self.assertIn("color:#d2ad61", window.source_label.text())
